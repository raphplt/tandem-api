### **Backend Wetwo — Architecture détaillée et guide de développement**

Wetwo est une application sociale conçue pour recréer la profondeur des échanges humains.
...
Wetwo est le premier réseau social basé sur la rareté, la sincérité et la présence.
